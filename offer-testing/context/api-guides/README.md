...
- **Contact information** (emails) → **Leadmagic**

### I need to research...
- **Industry trends and insights** → **Exa**
- **Company-specific news** → **Exa**
- **Competitive intelligence** → **Exa** or **Firecrawl**
...
- **Find emails first** → **Leadmagic**
- **Research targets first** → **Exa**, **Firecrawl**
...
2. **Enrichment** (Get detailed data)
   ...
   - Leadmagic: Find and verify email addresses
